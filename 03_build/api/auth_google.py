...
_REDIRECT_URI = os.environ.get("GOOGLE_REDIRECT_URI", "http://localhost:8000/auth/google/callback")
...
async def google_callback(
    ...
    try:
        ...
        return RedirectResponse(f"{_FRONTEND_URL}/login?google=success&google_user_id={user_id}")
